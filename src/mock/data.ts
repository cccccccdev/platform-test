  ...
  GTB_NG: [
    {
      ...
      configStatus: 'deployed' as const,
    ...
    },
    {
      ...
      singleNoField: '',
      matchFields: [],
      rules: [{ id: 'gtb_prod_single', fieldValues: {}, bt: 'COLLECTION', ability: 'CARD_PAY', action: 'TRANSACTION', requestType: 'CALLBACK' as const }],
