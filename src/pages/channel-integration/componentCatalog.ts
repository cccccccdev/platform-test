...
export const COMPONENT_CATALOG: ComponentDefinition[] = ([
  ...
  { id: 136, name: 'directSpiResponse', alias: 'Direct SPI Response', description: 'Return an SPI response directly without calling an external channel', usageCount: 1, needConfig: true, scopes: ['UPSTREAM_TRIGGERED'], status: 1 },
