...
export const COMPONENT_CATALOG: ComponentDefinition[] = ([
  ...
  { id: 136, name: 'directResponse', alias: 'Direct Response', description: 'Return a response directly without calling an external channel', usageCount: 1, needConfig: true, scopes: ['UPSTREAM_TRIGGERED'], status: 1 },
