...
export default function L4LibraryListPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (source: string) => (
        <Tag color={source === 'Public' ? 'blue' : 'orange'}>
          {source}
        </Tag>
      ),
    },
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      <div style={{ marginBottom: 24, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          <h2 style={{ marginBottom: 8 }}>公共模版库</h2>
          <Text type="secondary">共 {l4Templates.length} 个L4模版</Text>
        </div>
